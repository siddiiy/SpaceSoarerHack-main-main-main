...
public class Player : MonoBehaviour
{
    ...
    public WordGame wordGame;   //CAMERON

    private string[] wordList = { "blackhole", "star", "space", "nova", "maroon" };  //Cameron
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("wordPowerUp"))
        {
            ...
            if (wordGame != null)
            {
                ...
                wordGame.StartWordGame(randomWord);
            }
            else
            {
                Debug.LogError("wordGame is not assigned!");
            }
